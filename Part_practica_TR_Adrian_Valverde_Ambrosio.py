...
def cercaalumnes():
    ...
    etiquetadata1=customtkinter.CTkLabel(finestracercaalumnes1, text= "Data: ", height = 1, width = 20, text_font='Arial 10')
    etiquetadata1.grid(row=2, column=0, padx=10, pady=0, sticky="w")
    etiquetadata1def=customtkinter.CTkLabel(finestracercaalumnes1, text= horaf[3:-4] + " el dia " + dataf[3:-4] + " a l'aula " + aulaf[3:-4], height = 1, width = 20, text_font='Arial 10')
...
def cercaprofessors():
    ...
    if alumnes_tribunalf2 <= 51 and alumnes_tribunalf2 >= 1:
        ...
        alumnetribunal1=customtkinter.CTkLabel(finestracercaprofessors, text= "Tribunal de l'alumne: ", height = 1, width = 20, text_font='Arial 10')
        alumnetribunal1.grid(row=4, column=0, padx=10, pady=0, sticky="w")
        alumnetribunal1def=customtkinter.CTkButton(finestracercaprofessors, text= nomf[3:-4] + " " + primer_cognomf[3:-4] + " " + segon_cognomf[3:-4], height = 1, width = 20, text_font='Arial 10', command=professoralumne1)
        alumnetribunal1def.grid(row=4, column=1, padx=50, pady=20, sticky="w")
    ...
    if alumnes_tribunalf2 <= 51 and alumnes_tribunalf2 >= 1:
        ...
        alumnetribunal2=customtkinter.CTkLabel(finestracercaprofessors, text= "Tribunal de l'alumne: ", height = 1, width = 20, text_font='Arial 10')
        alumnetribunal2.grid(row=5, column=0, padx=10, pady=0, sticky="w")
        alumnetribunal2def=customtkinter.CTkButton(finestracercaprofessors, text= nomf4[3:-4] + " " + primer_cognomf4[3:-4] + " " + segon_cognomf4[3:-4], height = 1, width = 20, text_font='Arial 10', command=professoralumne2)
        alumnetribunal2def.grid(row=5, column=1, padx=50, pady=20, sticky="w")
    ...
    if alumnes_tribunalf2 <= 51 and alumnes_tribunalf2 >= 1:
        ...
        alumnetribunal3=customtkinter.CTkLabel(finestracercaprofessors, text= "Tribunal de l'alumne: ", height = 1, width = 20, text_font='Arial 10')
        alumnetribunal3.grid(row=6, column=0, padx=10, pady=0, sticky="w")
        alumnetribunal3def=customtkinter.CTkButton(finestracercaprofessors, text= nomf5[3:-4] + " " + primer_cognomf5[3:-4] + " " + segon_cognomf5[3:-4], height = 1, width = 20, text_font='Arial 10', command=professoralumne3)
        alumnetribunal3def.grid(row=6, column=1, padx=50, pady=20, sticky="w")
    else:
        pass
...
def finestratrsalumnes():
    ...
    botocercaalumnes.grid(row=1, column=0, padx=0, pady=0, sticky="e") 
    bototornar1=customtkinter.CTkButton(finestraalumnes,text="Tornar",command=tornarventanaalumne, height = 30, width = 60, text_font='Arial 12')
    bototornar1.grid(row=2, column=0, padx=50, pady=150, sticky="")
    etiqueta1=customtkinter.CTkLabel(finestraalumnes, text= "Escriu l'identificador:", height = 1, width = 20, text_font='Arial 12')    
    etiqueta1.grid(row=1, column=0, padx=50, pady=20, sticky="w")
    finestraalumnes.withdraw()
    cercaalumnes()
